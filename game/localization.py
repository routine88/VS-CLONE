...
def _build_default_catalog() -> LocalizationCatalog:
    ...
    english_strings: Dict[str, str] = {
        ...
        "cli.help.colorblind_mode": "Select a colorblind-friendly glyph palette",
        "cli.help.message_log": "Number of messages to keep visible",
        "cli.help.audio_cues": "Play supplemental accessibility audio cues",
    ...
    spanish_strings: Dict[str, str] = {
        ...
        "cli.help.colorblind_mode": "Selecciona una paleta de glifos para daltonismo",
        "cli.help.message_log": "Cantidad de mensajes visibles en pantalla",
        "cli.help.audio_cues": "Reproduce pistas de audio adicionales de accesibilidad",
